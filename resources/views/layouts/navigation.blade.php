            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(auth()->user() && auth()->user()->user_type == 'student')
                        <x-nav-link :href="route('user.userDetails', ['id' => auth()->user()->id])" :active="request()->routeIs('user.userDetails')">
                            User
                        </x-nav-link>
                        <x-nav-link :href="route('student.table')" :active="request()->routeIs('student.table')">
                            Timetable
                        </x-nav-link>
